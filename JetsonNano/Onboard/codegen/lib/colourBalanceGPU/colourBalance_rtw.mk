...
SRCS = $(START_DIR)/colourBalance_data.cu $(START_DIR)/colourBalance_initialize.cu $(START_DIR)/colourBalance_terminate.cu $(START_DIR)/colourBalance.cu
...
OBJS = colourBalance_data.o colourBalance_initialize.o colourBalance_terminate.o colourBalance.o
...
colourBalance_data.o : $(START_DIR)/colourBalance_data.cu
	$(CPP) $(CPPFLAGS) -o $@ $<


colourBalance_initialize.o : $(START_DIR)/colourBalance_initialize.cu
	$(CPP) $(CPPFLAGS) -o $@ $<


colourBalance_terminate.o : $(START_DIR)/colourBalance_terminate.cu
	$(CPP) $(CPPFLAGS) -o $@ $<


colourBalance.o : $(START_DIR)/colourBalance.cu
	$(CPP) $(CPPFLAGS) -o $@ $<
